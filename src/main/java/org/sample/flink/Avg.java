...
public class Avg
        implements WindowFunction<Order, OrderAgg, Tuple, TimeWindow> {
    ...
    public void apply(Tuple key, TimeWindow window, Iterable<Order> values, Collector<OrderAgg> out) {
        ...
        result.userId = key.getField(0).toString(); //may be there is a better way to get this value.Need to figure out:)
